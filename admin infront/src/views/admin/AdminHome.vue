...
import { getDisplayName } from "@/utils/adminUtils";
...
const getAdminInfo = () => {
	...
	console.log("获取到的管理员信息:", userInfo); // 调试日志

	// 使用新的工具函数
	adminName.value = getDisplayName(userInfo);

	console.log("显示的管理员名称:", adminName.value); // 调试日志
};
